...
public abstract class GUI {
	...
	protected abstract void chooseIntersection(Intersection i);
	
	protected abstract void onFindPath(boolean distance);
	
	protected abstract void onFindArti();
	...
	protected abstract void onWheelMove(MouseWheelEvent e);
	...
	private void initialise() {
		...
		start.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				chooseIntersection(Intersection.START);
				redraw();
			}
		});
		...
		JButton end = new JButton("End");
			...
			public void actionPerformed(ActionEvent ev) {
				chooseIntersection(Intersection.END);
				redraw();
			}
		});
		
		JButton path = new JButton("Find path(Distance)");
		...
		JButton disOrTime = new JButton("Find path(Time)");
		disOrTime.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				onFindPath(false);
				redraw();
			}
		...
		JButton arti = new JButton("ArticulationPoints");
