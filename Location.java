...
public class Location {
	...
	public static final double CENTRE_LAT = -36.847622;
	public static final double CENTRE_LON = 174.763444; //changed to public so that can be accessed in Graph class
